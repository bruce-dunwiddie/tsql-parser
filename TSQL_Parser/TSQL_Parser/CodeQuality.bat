SonarScanner.MSBuild.exe begin /k:"tsqlparser" /d:sonar.organization="bruce-dunwiddie-github" /d:sonar.host.url="https://sonarcloud.io" /d:sonar.login=%SONARQUBE_TOKEN%
